...
def get_scenario_instruction() -> str:
    ...
    structural_rule = (
        ...
        "A hard_level glued to the invalidation level (less than ~half an "
        "ATR away) leaves the close confirmation no room to work and will be "
        "widened to the automatic ATR buffer; declare a hard_level only for "
        "a real structural shelf, otherwise leave it null. "
